...
-- SEASONS IN THE COVID AND OUT OF THE COVID PERIOD
...
--------------------------------------------------------------
-- POPULATION AND INTENSIVE CARE CASES diff age groups in Intensive care

SELECT 
    YEAR(H.DATE_HOSP) AS Year,
    SUM(CASE WHEN PP.age0_19 THEN age0_19/total * H.NUM_INTENSE_CARE ELSE 0 END) AS Intensive_Care_0_19,
    SUM(CASE WHEN PP.age20_39 THEN age20_39/total * H.NUM_INTENSE_CARE ELSE 0 END) AS Intensive_Care_20_39,
    SUM(CASE WHEN PP.age40_59 THEN age40_59/total * H.NUM_INTENSE_CARE ELSE 0 END) AS Intensive_Care_40_59,
    SUM(CASE WHEN PP.age60_74 THEN age60_74/total * H.NUM_INTENSE_CARE ELSE 0 END) AS Intensive_Care_60_74,
    SUM(CASE WHEN PP.age75_et_plus THEN age75_et_plus/total * H.NUM_INTENSE_CARE ELSE 0 END) AS Intensive_Care_75_Plus
FROM 
    HOSPITALISATIONS H
INNER JOIN 
    PROJET_DEP PD ON H.DEP_ID = PD.codeD
INNER JOIN 
    PROJET_POPU PP ON PD.codeD = PP.codeD
INNER JOIN 
    PROJET_REG PR ON PD.codeR = PR.codeR
WHERE 
    YEAR(H.DATE_HOSP) IN (2020, 2021)
GROUP BY 
    YEAR(H.DATE_HOSP)
ORDER BY 
    YEAR(H.DATE_HOSP);
...
SELECT 
    YEAR(H.DATE_HOSP) AS Year,
    SUM(CASE WHEN PP.age0_19 THEN age0_19/total * H.NUM_DEATHS ELSE 0 END) AS DEATHS_0_19,
    SUM(CASE WHEN PP.age20_39 THEN age20_39/total * H.NUM_DEATHS ELSE 0 END) AS DEATHS_20_39,
    SUM(CASE WHEN PP.age40_59 THEN age40_59/total * H.NUM_DEATHS ELSE 0 END) AS DEATHS_40_59,
    SUM(CASE WHEN PP.age60_74 THEN age60_74/total * H.NUM_DEATHS ELSE 0 END) AS DEATHS_60_74,
    SUM(CASE WHEN PP.age75_et_plus THEN age75_et_plus/total * H.NUM_DEATHS ELSE 0 END) AS DEATHS_75_Plus
FROM 
    HOSPITALISATIONS H
INNER JOIN 
    PROJET_DEP PD ON H.DEP_ID = PD.codeD
