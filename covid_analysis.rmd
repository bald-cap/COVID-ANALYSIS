...
We would like to study the hospitalisation rates per seasons
...
print(hosp_rate_10K)
```
We then notice a high rate of hospitalisation in Winter(2.36422458) and colder seasons than in Summer(0.66048979).
