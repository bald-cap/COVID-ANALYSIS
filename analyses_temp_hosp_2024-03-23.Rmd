...
```
J'ai utilisé 10 000 habitants comme référence pour standardiser le taux d'hospitalisation. Selon le calcul du coefficient de corrélation, qui est de 0.7, il existe une relation positive significative entre la température et le taux d'hospitalisation. Cela suggère que les taux d'hospitalisation tendent à augmenter avec l'augmentation des températures. Cette relation peut indiquer des défis supplémentaires pour les systèmes de santé pendant les périodes plus chaudes. 
...
```
Cela est soutenu par ce graphique qui étudie l'indice CDD/HDD de 2018 à 2021. On remarque que les bâtiments avaient davantage besoin de chauffage entre 2018 et 2020, mais les indices CDD et HDD se rapprochent en 2021. 