...
### ETUDE D'HOSPITALISATIONS PENDANT LA PENDAMIE (2019-2020) ET HORS PERIODE COVID (2018-2021)

```{r GRAPHE COMPARAISON DES HOSPITALISATIONS 2019-2020 ET 2018-2021}
hosp_rate_10K_hors_covid <- dbGetQuery(
  connection,
  "SELECT
    AVG((NUM_HOSP/ total) * 10000) AS HOSP_RATE,
    CASE
...
hosp_rate_10K_covid <- dbGetQuery(
  connection,
  "SELECT
    AVG((NUM_HOSP/ total) * 10000) AS HOSP_RATE,
    CASE
