...
Cette analyse vise à explorer la relation entre les variations de température et les taux d'hospitalisation pendant les années fortement impactées par la pandémie de COVID-19, 2019 et 2020. Nous prenons aussi les temperatures une année avant et apres(c'est-a-dire 2018 et 2021) comme ___. Bien que les données directes sur les infections par la COVID-19 ne soient pas disponibles dans notre ensemble de données, nous examinons si les facteurs environnementaux, tels que la température, tels qu'enregistrés dans notre base de données `TEMPERATURES`, pourraient corrélérer avec les changements dans les modèles d'hospitalisation observés dans la table `HOSPITALISATIONS`.
...
### TAUX D' HOSPITALISATIONS EN FONCTIONS PAR SAISONS
